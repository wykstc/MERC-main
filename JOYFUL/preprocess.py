...
def get_iemocap():
    ...
    if args.dataset == "meld":
        (
            ...
            open("/home/lr/wangyi/ACL2023/MERC-main/JOYFUL/data/meld/MELD_features.pkl", "rb"), encoding="latin1"
        )
    ...
    train_vids, dev_vids = list(trainVids)[dev_size:], list(trainVids)[:dev_size]
